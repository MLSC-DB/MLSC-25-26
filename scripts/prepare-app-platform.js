...
function generateBase64ServiceAccount() {
    try {
        ...
        console.log('GOOGLE_SERVICE_ACCOUNT_JSON_BASE64 in your App Platform environment variables');
        ...
        console.log('- Only use it in App Platform\'s encrypted environment variables');
